...
public class MovieRecommendation {
    ...
    public static void main(String[] args) throws URISyntaxException {
        SparkSession spark = SparkSession.builder()
                ...
                .master("local[*]")
                .getOrCreate();
        MovieRecommendation main = new MovieRecommendation();
    ...
    public Dataset<Row> getUserRating(SparkSession spark) throws URISyntaxException {
        String path = getClass().getClassLoader().getResource("ratings_small.csv").toURI().getPath();
